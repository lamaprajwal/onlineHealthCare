...
{
    /// <inheritdoc />
    public partial class vvun : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HealthTestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthTest", x => x.HealthTestId);
                    table.ForeignKey(
                        name: "FK_HealthTest_AspNetUsers_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalCondition = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false),
                    Medications = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false),
                    Allergies = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false),
                    Surgeries = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false),
                    FamilyMedicalHistory = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", null, "Patient", "PATIENT" });
